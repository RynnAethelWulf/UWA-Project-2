...
def parse(url):
    searchKey = "Perth" # Change this to your city 
    checkInDate = '27/08/2021' #Format %d/%m/%Y
    checkOutDate = '29/08/2021' #Format %d/%m/%Y
    response = webdriver.Chrome("C:\bin")
    response.get(url)
